...
python2 scripts/ontonotes5_to_json.py ${SRL_PATH}/train.english.v5_gold_conll \
  ${SRL_PATH}/train.english.v5.jsonlines
python2 scripts/ontonotes5_to_json.py ${SRL_PATH}/dev.english.v5_gold_conll \
  ${SRL_PATH}/dev.english.v5.jsonlines
python2 scripts/ontonotes5_to_json.py ${SRL_PATH}/conll12test.english.v5_gold_conll \
...
python2 scripts/filter_conll2012_data.py ${SRL_PATH}/train.english.v5.jsonlines \
  ${SRL_PATH}/conll12.train.id \
  ${SRL_PATH}/train.english.mtl.jsonlines

python2 scripts/filter_conll2012_data.py ${SRL_PATH}/dev.english.v5.jsonlines \
  ${SRL_PATH}/conll12.dev.id \
  ${SRL_PATH}/dev.english.mtl.jsonlines

python2 scripts/filter_conll2012_data.py ${SRL_PATH}/conll12test.english.v5.jsonlines \
  ${SRL_PATH}/conll12.test.id \
  ${SRL_PATH}/test.english.mtl.jsonlines

# python2 scripts/filter_embeddings.py ${EMB_PATH}/glove.840B.300d.txt \
