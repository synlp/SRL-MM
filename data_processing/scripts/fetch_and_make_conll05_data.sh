...
python2 scripts/conll05_to_json.py "${CONLL05_PATH}/train-set" \
  "${SRL_PATH}/train.english.conll05.jsonlines" 5
python2 scripts/conll05_to_json.py "${CONLL05_PATH}/dev-set" \
  "${SRL_PATH}/dev.english.conll05.jsonlines" 5
python2 scripts/conll05_to_json.py "${CONLL05_PATH}/test-wsj" \
  "${SRL_PATH}/test_wsj.english.conll05.jsonlines" 1
python2 scripts/conll05_to_json.py "${CONLL05_PATH}/test-brown" \
